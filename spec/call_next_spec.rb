  ...
  context 'the prototyped object has an internal prototype' do
    context 'with params' do
      it 'calls the next implementation' do
        ...
        saludador_extra = prototyped.set_prototype(saludador_normal)
        ...
        saludador_loco = prototyped.set_prototype(saludador_extra)
      ...
      it 'delegates any given method to its prototype' do
        ...
        sub_prototype = prototyped.set_prototype(proto)
